...
| 8 | 2026-04-13 | inner-loop | Pulled user-run H2 prep results and added H2 ablation evaluation pipeline (`evaluate_h2_ablation.py` + `h2_colab_evaluate_ablation.ipynb`) to compare A1 vs C1/C2/C4 once model predictions are available. |
